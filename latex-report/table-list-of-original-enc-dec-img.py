...
if __name__ == "__main__":
    ...
    for file in os.listdir(original_img_dir):
        if(file != ".DS_Store"):
            print(str(idx) +" & \includegraphics[width=0.1\\textwidth]{assets/original/" + file + "} & \includegraphics[width=0.1\\textwidth]{assets/encrypted/" + file + "} & \includegraphics[width=0.1\\textwidth]{assets/decrypted/" + file + "}\\\\ \hline")
            print()
